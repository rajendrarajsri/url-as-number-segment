...
// Only register this if the old ozh_hyphen_in_charset plugin is not present
if( function_exists('ozh_hyphen_in_charset') ) {
    yourls_add_notice( "<b>URL as Number Segment</b> plugin may not function properly unless <b>hyphens-in-urls</b> plugin is deactivated first." );
} else {
